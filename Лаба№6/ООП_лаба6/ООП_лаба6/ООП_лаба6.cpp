...
int main() {
    ...
    Manager manager2("Bob Johnson", "Engineering Manager", 8000.0, 2500.0, "Company Car XYZ", 600);
    manager2.displayInfo();
    std::cout << "Annual Salary: $" << manager2.calculateAnnualSalary() << "\n";
    cout << "Итоговая годовая зарплата: $" << manager2.getTotalAnnualEarnings() << endl;
